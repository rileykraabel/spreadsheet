...
namespace SS
{
    ...
    /// <summary>
    /// Thrown to indicate that a name parameter is invalid. Ex: "" (empty string).
    /// </summary>
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        ///     This method handles 'visiting' items. It has four parameters; a starting item, the 'name' of the Cell,
        ///     a container of ISet<string> type to hold those that have been visited, and a LinkedList<string>
        ///     container to determine if an item has been 'visited'. 
        /// </summary>
        /// 
        /// <param name="start">
        ///     String type; the item we are starting at.
        /// </param>
        /// 
        /// <param name="name">
        ///     String type; the 'name' of the Cell we are looking within.
        /// </param>
        /// 
        /// <param name="visited"/>
        ///     ISet<string> type; holds the strings marked 'visited'.
        /// </param>
        ///
        /// <param name="changed"/>
        ///     LinkedList<string> type; holds the items we have changed to 'visited'.
        /// </param>
