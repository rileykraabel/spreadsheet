...
namespace SS
{
    ...
    public class Spreadsheet : AbstractSpreadsheet
    {
        ...
        public class Cell
        {
            ...
            public object GetCC() { return cellContents; }
        ...
        private readonly HashSet<string> changedCells;
        ...
        private bool IsValidName(string name)
        {
            ...
            if (Regex.IsMatch(name, allowedPattern) && name != null && name != "")
                return true;
        ...
        {
            // NOTE: Only checking for "" empty string right now.
            if (name == "")
        ...
        private IList<string> ReplaceContents(string name, object item)
        {
            if (cellPairs.ContainsKey(name))
            {
                ...
                depGraph.ReplaceDependees(name, depGraph.GetDependees(item.ToString()));
                cellPairs[name].SetCC(item);
        ...
        public Spreadsheet(string filepath, Func<string, bool> isValid, Func<string, string> normalize, string version) : base(isValid, normalize, version)
        {
                    ...
                    while (reader.Read())
                    {
                        ...
                        else
                        {
                            ...
                            if (reader.Name == "Spreadsheet")
                                Console.WriteLine("end of spreadsheet file");
                        }
            ...
            {
                cellPairs.Add(item, new Cell(item));

                foreach (string contentItem in cellContents)
                    SetContentsOfCell(item, contentItem);
        ...
        public override IEnumerable<string> GetNamesOfAllNonemptyCells()
        {
            ...
            {
                if (!NullOrInvalid(cellName) && GetCellContents(cellName) != "" && GetCellContents(cellName) != null)
        ...
        protected override IList<string> SetCellContents(string name, double number)
        {
            ...
            List<string> cells = new List<string>(ReplaceContents(Normalize(name), number));
        ...
        protected override IList<string> SetCellContents(string name, string text)
        {
            ...
            changedCells.Add(name);
            return ReplaceContents(name, text);
            return ReplaceContents(Normalize(name), text);
        }
        ...
        protected override IList<string> SetCellContents(string name, Formula formula)
        {
            ...
            try
            {
                foreach (string item in formula.GetVariables())
                    depGraph.AddDependency(item, name);
        ...
        public override IList<string> SetContentsOfCell(string name, string content)
        {
            ...
            {
                contents = new List<string>(SetCellContents(Normalize(name), result));
            }
            ...
            else if (content.StartsWith("="))
            {
                ...
                contents = new List<string>(SetCellContents(Normalize(name), formula));

                foreach (string item in contents)
                    cellPairs[item].SetValue(formula.Evaluate(Lookup));

            }

            else
                contents = new List<string>(SetCellContents(Normalize(name), content));
        ...
        public override object GetCellValue(string name)
        {
            ...
            if (cellPairs.ContainsKey(Normalize(name)))
                return cellPairs[Normalize(name)].GetValue();
