...
namespace SpreadsheetTests
{
    ...
    public class SpreadsheetTests
    {
        ...
        /// <summary>
        ///     This test is made to ensure that if a file is read through the constructor,
        ///     its' version is able to be found, and we can use the changed field to determine
        ///     if it has been done accurately or not.
        /// </summary>
        [TestMethod()]
        public void TestSimpleSaveWithVersionConstructor3()
        {
            AbstractSpreadsheet sheet1 = new SS.Spreadsheet();
            sheet1.SetContentsOfCell("A1", "soup");
            sheet1.Save("banana20.xml");

            AbstractSpreadsheet sheet3 = new SS.Spreadsheet("banana20.xml", v => true, n => n.ToLower(), "");
            sheet3.SetContentsOfCell("cheese1", "=10-10");
            sheet3.SetContentsOfCell("tomato12", "=20*0");

            Assert.AreEqual(true, sheet3.Changed);

            sheet3.Save("banana21.xml");

            Assert.AreEqual(false, sheet3.Changed);

            Assert.AreEqual("default", sheet3.GetSavedVersion("banana20.xml"));
        }
